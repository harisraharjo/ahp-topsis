...
export const Navbar = ({}: NavbarProps) => {
  return (
    <nav className="relative flex flex-wrap items-center justify-between rounded-2xl py-2 transition-all duration-250 ease-soft-in lg:flex-nowrap lg:justify-start">
