        ...
        <ul className="mb-0 flex flex-col pl-0">
          <li className="mt-0.5 w-full">
            ...
            >
              ...
              <svg
                ...
                className="shadow-soft-2xl mr-2 h-8 w-8 items-center justify-center rounded-lg bg-white bg-gradient-to-tl from-purple-700 to-pink-500 bg-center stroke-0 text-center xl:p-2.5"
              >
                <title>shop</title>
          ...
          <li className="mt-0.5 w-full">
            ...
            >
              <div
                className="
              shadow-soft-2xl mr-2 h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5
              "
              >
                <svg
                  width="12px"
...
//   "shadow-soft-xl rounded-lg bg-white font-semibold text-slate-700"
// const activeSVG: ActiveSVG = "bg-gradient-to-tl from-purple-700 to-pink-500"
...
export type SidebarSwitch = Omit<
